...
public class PropertiesXML implements Path {
    public static void main(String[] args) {
        ...
        System.out.println("name --> " +PropertiesXML.getPropertyXML("name","prop.xml"));
        System.out.println("phone --> " +PropertiesXML.getPropertyXML("phone","prop.xml"));
    }
